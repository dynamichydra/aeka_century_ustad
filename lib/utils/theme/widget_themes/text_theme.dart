...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.bold, color: TColors.textPrimary),
    headlineSmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.bold, color: TColors.textPrimary),

    titleLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: TColors.textPrimary),
