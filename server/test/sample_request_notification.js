...
const data = {
  ...
  leadNo: "LD-4578",
  products: [
    { name: "Royce Walnut", sku: "5413 SU", qnt: "4" },
    { name: "Malmo Walnut Brown", sku: "3417 SU", qnt: "2" },
  ],
};

// ✅ Function to parse plain text and convert into styled HTML
function generateHtmlFromText(template, data) {
  // --- Handle loop ---
...
const htmlContent = generateHtmlFromText(template, data);
...
async function sendEmail(to, subject, htmlContent) {
  ...
  const mailOptions = {
    from: '"Sample Request" <your.email@gmail.com>',
    to,
    subject,
    html: htmlContent,
  };
...
// sendEmail("rahul.sharma@example.com", "New Sample Request", htmlContent);
